...
import { MapPin, Calendar, Users, RotateCcw, MoreVertical } from 'lucide-react'
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
      ...
      <div className="max-w-4xl mx-auto px-4 py-4">
        ...
        <div className="flex flex-wrap gap-1">
          {preferences.travelStyles.map((style) => (
            <span
              key={style}
              className="px-2 py-0.5 bg-secondary text-secondary-foreground rounded text-xs capitalize"
            >
              {style}
            </span>
          ))}
